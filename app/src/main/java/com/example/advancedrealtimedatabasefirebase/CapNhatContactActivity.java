...
public class CapNhatContactActivity extends AppCompatActivity {
    ...
    EditText edtId,edtTen,edtLoai,edtGia;
        ...
        myRef.child(key).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                try {
                    ...
                    edtTen.setText(contact.getTensp());
                    edtLoai.setText(contact.getLoaisp());
                    edtGia.setText(contact.getGiasp());
    ...
    public void xuLyCapNhat(View view) {
        try {
            ...
            myRef.child(contactId).child("loaisp").setValue(loai);
            myRef.child(contactId).child("giasp").setValue(gia);
